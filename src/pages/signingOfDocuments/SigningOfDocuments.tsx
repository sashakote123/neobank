...
const SigningOfDocuments = () => {
  const { isShowForm, setIsShowForm, isLoading } = useApplicationStep('signing');
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className={styles.textInfo}>
            ...
            influence the Partner Banks are. By leaving an application, you agree to the processing
            of personal data, obtaining information, obtaining access to a credit history, using an
            analogue of a handwritten signature, an offer, a policy regarding the processing of
