...
const mockNewsData = [
  ...
  },
  {
    ...
    pubDateTZ: "UTC",
    image_url:
      "https://cdn.guardian.ng/wp-content/uploads/2020/03/SIM-cards.jpg",
  },
  {
  ...
  },
  {
    ...
    pubDateTZ: "UTC",
    image_url:
      "https://www.brandonsun.com/wp-content/uploads/sites/3/2022/11/squaresun_web.jpg",
  },
  {
  ...
  },
  {
    ...
    pubDateTZ: "UTC",
    image_url:
      "https://menafn.com/updates/pr/2025-08/06/I_ff7adimage_story.jpg",
  },
  {
    ...
    pubDateTZ: "UTC",
    image_url:
      "https://www.livemint.com/lm-img/static/1yr/newmintdefault-120.png",
  },
];
...
describe("CardBanner", () => {
  ...
  test("Отображает новости при успешном запросе", async () => {
    axios.get.mockResolvedValue(mockNewsData);
  ...
  //   test("Отрисовывается массив старых новостей", () => {
  //     render(<News />);
